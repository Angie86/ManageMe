...
@NamedQueries({
    ...
    @NamedQuery(name = "DataUsers.findByPhotoUser", query = "SELECT d FROM DataUsers d WHERE d.photoUser = :photoUser")})
public class DataUsers implements Serializable {
    private static final long serialVersionUID = 1L;
    
    @Id
    @SequenceGenerator(name = "seq_dataUser", sequenceName = "SEQ_DATAUSERS", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_dataUser")
    ...
    public String toString() {
        return "ManageMe.ejb.DataUsers[ idDatauser=" + idDatauser + " ]";
    }
